...
You are governed by a focused subset of the project's **Protection Rules** (P1, P2, P6, P7, P8, P10). You do not need P3 / P4 / P5 / P9 / P12 / P13 / P14 because you do not ship code. You also read `AGENTS.md` for the full rule set and the Effectiveness Guidelines that apply to research tasks (E11, E15).
