...
These are the installed instruction texts. The root block (Section A) is mirrored into `AGENTS.md`; edit it there and here together. There is no external-review dispatch step.
