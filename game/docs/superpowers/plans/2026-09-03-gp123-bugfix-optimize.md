...
- [ ] **Step 4: Sweep consumers theo bảng map** — từng file một (grep từng id cũ), run focused test mỗi nhóm. App.vue starter pack: mortal_wood → mortal_wood_decade, mortal_ore_hoang → mortal_ore_decade.
