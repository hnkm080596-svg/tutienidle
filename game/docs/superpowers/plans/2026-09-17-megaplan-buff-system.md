...
> **Review revision:** v6 — incorporates code review round 5 (verdict REQUEST CHANGES on `cb3a602f`: 3 BLOCKER / 3 HIGH / 3 MEDIUM). Fixes in this revision:
...
**Specs:**
- `game/docs/specs/2026-09-17-buff-system-reimagined-spec.md` (v1.4 — THE source of truth; section numbers below cite it; v1.1–v1.4 addenda lock the implementation deltas)
...
export class BuffSystem {
  ...
  // claim their resolutions. {started:false} when the selector matched no
  // live unit; candidateUnitCount = the ordered list size at trigger time
  // (candidates, NOT promised resolutions — later units may skip).
...
v6 — r5-review BLOCKER 1 truthful return):
  ...
  skip dead units; take the first live unit:
