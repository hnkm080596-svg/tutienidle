...
describe('buffs.ts — ported definitions match original values (buff2 shape)', () => {
  ...
  describe('buff mới chuỗi Thuần (spec §7)', () => {
    ...
    it('all 70 definitions (6 inline + 16 legacy + 1 Kiem Pho + 14 thuan-he + 5 talent + 3 boss + 16 the_tu + 5 reaction + 4 companion) are present', () => {
      expect(buffs).toHaveLength(70)
    })
  })
