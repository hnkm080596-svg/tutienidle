...
// KHONG mang name/description (Slice 2 spec sec.3 -- shape gameplay thuan);
// lop display metadata nay tach rieng ?e content pass skill sau nay chi
// can bo sung 1 entry o ?ay.
//
// Nguon du lieu:
// - id trung SKILLS (Skills.ts) -> ?ONG BO name/description tu bang Skill
...
//   tai ?ay, kem so lieu ?oi chieu file authored tuong ung.
...
/** ?ong bo tu SKILLS: name/description lay ?ung bang skill that. */
...
export const TURN_SKILL_DISPLAY_META: Record<string, TurnSkillDisplayMeta> = {
  ...
  // The Tu Reimagined (spec 2026-09-15 sec.2.3) -- mortal cast-leveled
  ...
  // 5 Phap Tu Thuan He -- ?ong bo tu Skills.ts.
