...
export const SKILLS: Skill[] = [
  ...
  // ==================================================================
  // Pháp Tu Đạo Sắc (spec 2026-08-30-phap-tu-dao-sac §2.2) — 20 skill
  // chuỗi combo Thuần hệ B/C/D/E của 5 thần Sơn Hải Kinh. A là root
  // skill hiện có của từng hành (hoa_cau_thuat / thuy_tien_thuat /
  // doc_chuong / diem_kim_thuat / tho_cau_thuat). Dấu ấn cơ chế mỗi
  // hành theo spec §2.2; số liệu damage/cooldown là KHỞI ĐIỂM
  // playtest. Unlock qua node chuỗi trong PhapTuNodes.ts (Task 11),
  // KHÔNG tự học — chỉ B-E cần unlock (A mua như cũ qua root node).
  // Cast hoàn tất mới advance chuỗi (BattleSystem.advanceChainAndGainThe).
  // ==================================================================

  // ── Chuỗi CHÚC DUNG (Hỏa — bùng nổ dồn, Chúc Dung hỏa thần Nam
  // phương): B/C chồng Thiêu Đốt, D kích nổ toàn bộ Bỏng (Detonate
  // consumesAilmentId), E nuke lan đòn kết chuỗi.
  {
    id: 'chuc_dung_b',
    name: 'Liệt Diễm Chúc Dung',
    description: 'Phóng liệt diễm nối tiếp Hỏa Cầu, thêm 1 tầng Bỏng chồng lên mục tiêu.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 3,
  ...
  },
  {
    ...
    description: 'Tam Muội Hỏa đốt ba tầng — Bỏng mạnh hơn, lan sang kẻ đứng cạnh.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 5,
  ...
  {
    id: 'chuc_dung_d',
    name: 'Dẫn Nộ Hỏa Thần',
    description: 'Chúc Dung dẫn nộ — kích nổ TOÀN BỘ Bỏng đang trên mục tiêu thành 1 cục true damage lớn.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 8,
  ...
  },
  {
    ...
    description: 'Con đường lửa của Chúc Dung — đòn kết chuỗi, cột lửa thiêng đốt trời.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 12,
  ...
  // ── Chuỗi THIÊN NGÔ (Thủy — kiềm chế + hồi, Thiên Ngô "Thủy Bá" 8
  // đầu 8 chân): B Tê Cóng, C hồi Pháp Lực, D trói/hấp thụ, E sóng càn.
  {
    id: 'thien_ngo_b',
  ...
  {
    id: 'thien_ngo_c',
    name: 'Thanh Tuyền Dưỡng Khí',
    description: 'Suối thiêng của Thủy Bá — ngưng sương nuôi Pháp Lực (hồi Linh Lực nhanh trong 6s).',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 5,
    ...
    execution: { kind: 'cast_time', castTime: 1.2 },
    target: 'self',
    effects: [{ type: 'buff', buffId: 'ngung_lo', duration: 6 }],
    resourceType: 'none',
    unlocked: false,
    equipped: false,
  },
  {
    ...
    description: 'Vòng nước Thiên Ngô cuốn hút — trói chân mục tiêu, hấp thụ đòn đánh.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 8,
  ...
  {
    id: 'thien_ngo_e',
    name: 'Thiên Ngô Bát Vân',
    description: 'Tám đầu dâng tám đợt sóng càn — đòn kết chuỗi quét sạch chiến trường.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 12,
  ...
  // ── Chuỗi CÂU MANG (Mộc — nhiễm độc lan, Câu Mang mộc thần Đông
  // phương thân chim mặt người): B Trúng Độc, C rễ cấm di chuyển, D
  // lan độc, E vườn độc nổ rễ.
  {
    id: 'cau_mang_b',
    name: 'Xuân Sanh Độc Dực',
    description: 'Câu Mang phủ cành độc — Trúng Độc bám vào mục tiêu.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 3,
  ...
  {
    id: 'cau_mang_c',
    name: 'Mộc Nhiễm Căn Trì',
    description: 'Rễ Câu Mang mọc trùm lên mục tiêu — cấm di chuyển, độc ngấm sâu.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 5,
  ...
  {
    id: 'cau_mang_d',
    name: 'Vạn Mộc Thời Hư',
    description: 'Khu rừng Câu Mang lặng lẽ lan — kích nổ Trúng Độc thành true damage, hút nửa sinh lực hồi bản thân.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 8,
  ...
  {
    id: 'cau_mang_e',
    name: 'Kiến Mộc Thần Lâm',
    description: 'Thần thụ Kiến Mộc giáng thế — vườn độc nổ tung rễ trăm trượng (đòn kết chuỗi).',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 12,
  ...
  // ── Chuỗi NHỤC THU (Kim — nghiền nát kim loại, Nhục Thu kim thần
  // Tây phương chủ mùa Thu; KHÔNG kiếm pháp — tách Kiếm Tu hoàn toàn):
  // B Kim Châm Xuất Huyết, C Kim Giáp phản đòn, D Kim Chung cộng hưởng
  // Xuất Huyết, E Kim Luân Trấn Áp đè nghiền.
  {
    id: 'nhuc_thu_b',
    name: 'Kim Châm Vũ',
    description: 'Nhục Thu rắc mưa kim châm — vụn thép gây Xuất Huyết.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 3,
  ...
  {
    id: 'nhuc_thu_c',
    name: 'Thu Giáp Kim Thành',
    description: 'Thu sát ngưng thành giáp thép — tự hoá kim, dày thêm phòng thủ.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 5,
    ...
    execution: { kind: 'cast_time', castTime: 1.2 },
    target: 'self',
    effects: [{ type: 'buff', buffId: 'khai_son', duration: 6 }],
    resourceType: 'none',
    unlocked: false,
    equipped: false,
  },
  {
    ...
    description: 'Chuông thép Nhục Thu rung — cộng hưởng kích nổ TOÀN BỘ Xuất Huyết trên mục tiêu.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 8,
  ...
  {
    id: 'nhuc_thu_e',
    name: 'Kim Luân Trấn Ấp',
    description: 'Đĩa thép khổng lồ của Nhục Thu đè nghiền — nổ toàn bộ Xuất Huyết (đòn kết chuỗi).',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 12,
  ...
  // ── 5 ULTIMATE Thuần hệ (spec §2.4) — mở khi Thế đầy 100 qua nút
  // manual + auto-AI (UltimateSystem.phapTu), KHÔNG chiếm loadout
  // slot. Unlock qua node major Trúc Cơ của từng nhánh (PhapTuNodes).
  {
    id: 'tat_phuong',
    name: 'Tất Phương Diểu Hỏa',
    description: 'Điểu hỏa một chân hiện thế — nơi Tất Phương đáp là nơi cháy lớn (nuke AoE + Bỏng toàn trận).',
    type: 'active',
    level: 1,
    maxLevel: 5,
    cooldown: 0,
  ...
  },
  {
    ...
    description: 'Tám đầu Thiên Ngô dâng tám đợt sóng — càn quét sạch mọi địch (AoE mạnh + Tê Cóng).',
    type: 'active',
    level: 1,
    maxLevel: 5,
    cooldown: 0,
  ...
  {
    id: 'kien_moc',
    name: 'Kiến Mộc Giáng Thế',
    description: 'Thụ thần nối trời đất giáng trần — vườn độc nổ rễ trăm trượng trói mọi địch.',
    type: 'active',
    level: 1,
    maxLevel: 5,
    cooldown: 0,
  ...
  },
  {
    ...
    description: 'Thu là mùa hình phạt — đĩa thép Nhục Thu đè nghiền mục tiêu, nổ toàn bộ Xuất Huyết.',
    type: 'active',
    level: 1,
    maxLevel: 5,
    cooldown: 0,
  ...
  },
  {
    ...
    description: 'Thành đất thiêng Hậu Thổ nhốt mọi địch trong lũy — trấn áp hoàn toàn (AoE + Trói Chân).',
    type: 'active',
    level: 1,
    maxLevel: 5,
    cooldown: 0,
  ...
  // ── Chuỗi HẬU THỔ (Thổ — phòng tuyến, Hậu Thổ thổ thần trung
  // phương): B Thạch Hóa, C cột đỡ đòn (ward), D chấn địa AoE, E
  // thành lũy nhốt target.
  {
    id: 'hau_tho_b',
    name: 'Hậu Thổ Trấn Ách',
    description: 'Hậu Thổ vá trời — Thạch Hóa hoá thân địch, thân cứng chậm né.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 3,
  ...
  },
  {
    ...
    description: 'Cột đất thiêng đỡ trời — sinh tầng khiên hộ thể cho bản thân.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 5,
    ...
    execution: { kind: 'cast_time', castTime: 1.2 },
    target: 'self',
    effects: [{ type: 'buff', buffId: 'thach_giap_buff', duration: 5 }],
    resourceType: 'none',
    unlocked: false,
    equipped: false,
  },
  {
    ...
    description: 'Chấn địa Côn Lôn — đòn AoE diện rộng, mọi kẻ đứng trên đất rung chuyển.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 8,
  ...
  {
    id: 'hau_tho_e',
    name: 'Cửu Trù Thành Lũy',
    description: 'Thành đất Hậu Thổ nhốt mục tiêu trong lũy — đòn kết chuỗi trấn áp hoàn toàn.',
    type: 'active',
    level: 1,
    maxLevel: 10,
    cooldown: 12,
...
// chuỗi 5 skill theo hành cho ChainDefinition (BattleSystem.
// setChainDefinition) + node unlock (PhapTuNodes). A là root hiện có
// của hành; B–E là 20 skill mới bên trên.
export const CHAIN_SKILL_IDS: Record<ElementType, readonly string[]> = {
  ...
  wood: ['doc_chuong', 'cau_mang_b', 'cau_mang_c', 'cau_mang_d', 'cau_mang_e'],
  metal: ['diem_kim_thuat', 'nhuc_thu_b', 'nhuc_thu_c', 'nhuc_thu_d', 'nhuc_thu_e'],
  earth: ['tho_cau_thuat', 'hau_tho_b', 'hau_tho_c', 'hau_tho_d', 'hau_tho_e'],
}
