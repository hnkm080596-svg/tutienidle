...
// "lưu lại flag của các trạng thái tự động" (tự động đột phá, tự động
// dùng Tinh Hoa, chế độ auto-refight) nên chúng SURỐNG qua reload.
//
...
export interface UiAutomationFlagSnapshot {
  /** Auto Đột Phá tiểu cảnh giới (CharacterPanel). */
