...
.overlay-panel__card { max-width: 100%; max-height: 94vh; min-height: 0; display: flex; flex-direction: column; overflow: hidden; container-type: inline-size; container-name: overlay-panel; color: var(--text-primary); font-family: var(--font-body); background: linear-gradient(155deg, var(--ink-800), var(--ink-950)); border: 1px solid var(--chrome-500); border-radius: var(--radius-md); box-shadow: var(--shadow-panel); }
...
.overlay-panel__body { flex: 1 1 auto; min-height: 0; display: flex; flex-direction: column; overflow: hidden; }
