...
// (old cuong_chien/tran_the grant sets no longer exist; core_phan_
// chinh retired from NATIVE_CORE_SKILL_IDS), so a v84 save with the-
// tu investment can no longer validate. Save v84 is rejected (dev
// phase, no migration, no compat translator) - master spec sec.8.4.
