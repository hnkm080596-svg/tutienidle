...
import { MAX_SWORD_INTENT, MAX_HOA_THE, MAX_THO_THE, MAX_KIM_THE, MAX_HUYET_PHA } from '../combat/CombatTypes'
...
// today's game (none currently) would map to Infinity; all current
// pools have one.
