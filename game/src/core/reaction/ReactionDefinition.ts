...
/** Stack-expression DSL (contract sec.31+; payoff math may use doubles --
    fixed-point is required only for selection weight). Closed union,
    evaluated against the reaction snapshot in M4. */
