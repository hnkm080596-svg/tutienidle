// RETIRED (Completion Task 9, 2026-09-04) — mechanic: gate
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.gate.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem gate (real-time) — xem comment đầu file', () => {
