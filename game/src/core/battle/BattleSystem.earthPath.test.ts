// RETIRED (Completion Task 9, 2026-09-04) — mechanic: earthPath
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.earthPath.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem earthPath (real-time) — xem comment đầu file', () => {
