// RETIRED (Completion Task 9, 2026-09-04) — mechanic: teleport
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.teleport.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem teleport (real-time) — xem comment đầu file', () => {
