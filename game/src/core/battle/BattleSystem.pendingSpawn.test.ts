// RETIRED (Completion Task 9, 2026-09-04) — mechanic: pendingSpawn
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.pendingSpawn.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem pendingSpawn (real-time) — xem comment đầu file', () => {
