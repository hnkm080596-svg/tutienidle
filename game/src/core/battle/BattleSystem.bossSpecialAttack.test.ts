// RETIRED (Completion Task 9, 2026-09-04) — mechanic: bossSpecialAttack
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.bossSpecialAttack.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem bossSpecialAttack (real-time) — xem comment đầu file', () => {
