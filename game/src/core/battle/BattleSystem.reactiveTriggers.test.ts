// RETIRED (Completion Task 9, 2026-09-04) — mechanic: reactiveTriggers
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.reactiveTriggers.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem reactiveTriggers (real-time) — xem comment đầu file', () => {
