// RETIRED (Completion Task 9, 2026-09-04) — mechanic: deadCast
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.deadCast.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem deadCast (real-time) — xem comment đầu file', () => {
