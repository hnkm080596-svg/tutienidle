// RETIRED (Completion Task 9, 2026-09-04) — mechanic: skillFlow
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.skillFlow.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem skillFlow (real-time) — xem comment đầu file', () => {
