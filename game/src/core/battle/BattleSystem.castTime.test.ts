// RETIRED (Completion Task 9, 2026-09-04) — mechanic: castTime
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.castTime.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem castTime (real-time) — xem comment đầu file', () => {
