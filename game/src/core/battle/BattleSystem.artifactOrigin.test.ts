// RETIRED (Completion Task 9, 2026-09-04) — mechanic: artifactOrigin
//
...
//
// Nội dung gốc nằm trong git history: git log --follow -- BattleSystem.artifactOrigin.test.ts

import { describe, expect, it } from 'vitest'

describe('RETIRED: BattleSystem artifactOrigin (real-time) — xem comment đầu file', () => {
