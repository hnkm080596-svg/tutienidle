...
- Ruling (user, repeated): dev-phase — NO backward-compatibility work. Old saves keep numeric values and accept semantic shifts (e.g. realmLevel 9/18 mid-realm); no migrations/remaps, and derived scaling follows the canonical model even when totals rise. Do not re-raise compat findings.
