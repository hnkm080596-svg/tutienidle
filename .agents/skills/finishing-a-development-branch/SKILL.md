...
- The P18 OCR gate is clean on the current aggregate diff with full coverage accounting (or the user has explicitly waived P18 after a recorded environment gap).
